                ...
                <div className="mx-auto" style={{ maxWidth: "500px" }}>
                    ...
                    <form action="perfil" method="get">
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" id="inputEmail4"placeholder="ejemplo@correo.com"/>
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label"> <b>Contraseña</b></label>
                            <input type="password" class="form-control" id="inputPassword4"placeholder="Ingrse una contraseña"/>
                        </div>
                        <div class="col-12">
                            <label for="inputAddress" class="form-label"> <b>Dirección</b></label>
                            <input type="text" class="form-control" id="inputAddress" placeholder="Calle 00 # 00 - 00"/>
                        </div>
                        <div class="col-12">
                            <label for="inputAddress2" class="form-label"> <b>Nombres</b></label>
                        ...
                        <div class="col-md-6">
                            <label for="input" class="form-label"> <b>Ocupación</b></label>
